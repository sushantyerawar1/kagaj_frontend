...
const Request = () => {
    ...
    const AppendUrl = async () => {
        ...
        try {
            ...
            const { data } = await axios.post(
                "https://kagaj-backend-6p7z.onrender.com/api/issue/submitted",
                {
                    "url": pdfUrl,
                    "id": selectedid,
                },
    ...
    const FetchAllRequets = async () => {
        ...
        try {
            ...
            const Data = await axios.get(
                "https://kagaj-backend-6p7z.onrender.com/api/issue/getall",
                config
            );
    ...
    const RejectIssue = async (id) => {
        try {
            ...
            const { data } = await axios.post(
                "https://kagaj-backend-6p7z.onrender.com/api/issue/rejected",
                {
                    "id": id,
                },
                config
